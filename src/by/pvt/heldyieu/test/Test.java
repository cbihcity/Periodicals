...
//import by.pvt.heldyieu.service.SubscriptionService;
...
//		Date start = new Date();
//		Subscription subscription1 = new Subscription(1, user1, mag1, type2, start);
//		Subscription subscription2 = new Subscription(2, user2, mag3, type1, start);
//		SubscriptionService subscriptionService = SubscriptionService.getInstance();
//		UserService userService = UserService.getInstance();
//		
//		try {
//			Subscription subscription1 = subscriptionService.getSubscription(1);
